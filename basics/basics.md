...
### 25. Display counting from n to 1 using while loop
...
### 31. Display sum of first n natural nos.  Using while loop
...
### 32. Display average marks of n number of students, take inputs from  user Using while loop 
...
### 39. Display sum of first 50 even nos. Using for loop 
...
### 40. Display sum of first 50 odd nos. Using for loop
...
### 41. Display first 50 multiples of 7 using for loop
...
### 42. Display sum of first n natural nos. using for loop
...
### 49. Display the following pattern on screen: ( Up to n rows)
...
### 50. Display the following pattern on screen( inverted full pyramid): ( Up to n rows)
	...
	/Display the following pattern on screen( inverted full pyramid): ( Up to n n)
	...
	*/
	...
	// logic: first row of stars is (n*2)-1..... 
