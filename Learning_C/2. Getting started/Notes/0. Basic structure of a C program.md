...
#include <stdio.h> 
/* #include basically 'includes' another file into your program. H
...
// Curly braces are used for intendation in most of the compiled languages including C. This simply means that spaces between tokens, e.g., doesn't even matter here unlike in languages like python. More broadly, the below implementation would also work just as fine
...
#include <stdio.h>
int main(){printf("This line would be printed on screen upon executing! ");}
